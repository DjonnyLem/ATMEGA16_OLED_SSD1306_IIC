...
void Init_TIMER0_COMP(void)
{
	...
	//	(1/8.000.000)*64(ПРЕСКАЛЕР)=0,000008 тактов в сек

	//	0.001 sec/0,000008 тактов = 125 тактов в 1ms - #define COUNT_TIMER 125  ~ каждые 1mc
	//	
	//=========================================================
//			  7       6       5       4       3      2        1	
//	TCCR0 = FOC00 | WGM00 | COM01 | COM00 | CS02 | CS01 |	CS00
	...
	TCCR0 |=(0<<CS02)|(1<<CS01)|(1<<CS00)|(1<<WGM01)|(0<<WGM00);  	//011-64
